...
const Flota = () => {
  return (
    <div className={style["flota-container"]}>
      ...
      <section className={style['container-all']}>
        <div className={style["container-truck"]}>
          <h2>Camiones</h2>
        ...
        <div className={style["container-varios"]}>
          <h2>Varios</h2>
